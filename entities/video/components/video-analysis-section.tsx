...
import ChatInterface from "@/entities/chat/components/chat-interface";
import Timeline from "@/entities/timeline/components/time-line";
import { useVideoStore } from "@/entities/video/store/video-store";
import { Button } from "@/shared/components/ui/button";
import YouTubePlayer from "@/shared/components/youtube-player";
